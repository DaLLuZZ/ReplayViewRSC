...
(function (Facepunch) {
    var Http = /** @class */ (function () {
        ...
        Http.getString = function (url, success, failure, progress) {
            ...
            if (failure != null) {
                request.addEventListener("error", function (ev) { return failure(request.responseText); });
        ...
        Http.getAbsUrl = function (url, relativeTo) {
            ...
            if (relativeTo.charAt(relativeTo.length - 1) === "/") {
                return "".concat(relativeTo).concat(url);
            }
                ...
                for (var i = 0, iEnd = this.commands.length; i < iEnd; ++i) {
                    ...
                    for (var name_3 in command) {
                        ...
                        switch (name_3) {
                            ...
                            case "mode":
                            case "type":
                                value = "GL_".concat(Facepunch.WebGl.encodeConst(value));
                                break;
                            case "parameter":
                            case "parameters":
                                value = undefined;
                        ...
                        if (value !== undefined)
                            params.push("".concat(name_3, ": ").concat(value));
                    }
                    ...
                    commands.push("".concat(this.getCommandName(command.action), "(").concat(paramsJoined, ");"));
                }
        ...
        var FrameBuffer = /** @class */ (function () {
            ...
            FrameBuffer.prototype.unbindAndCheckState = function () {
                ...
                if (state !== gl.FRAMEBUFFER_COMPLETE) {
                    throw new Error("Unexpected framebuffer state: ".concat(state, "."));
                }
            };
        ...
        var Game = /** @class */ (function () {
            function Game(container) {
                ...
                window.addEventListener("mousewheel", function (evnt) {
                    var handled = _this.onMouseScroll(evnt.deltaY);
                    if (handled)
                        evnt.preventDefault();
                    return handled;
                });
            ...
            Game.prototype.enableExtension = function (name) {
                if (this.context.getExtension(name) == null) {
                    console.warn("WebGL extension '".concat(name, "' is unsupported."));
                }
            };
                ...
                switch (info.type) {
                    ...
                    case MaterialPropertyType.TextureInfo: {
                        ...
                        var tex = this.properties[info.name] = texInfo.path != null
                            ...
                            : this.game.textureLoader.load("__dummy_".concat(MaterialLoadable.nextDummyId++));
                        tex.addDependent(this);
        ...
        var MeshGroup = /** @class */ (function () {
            ...
            MeshGroup.prototype.addIndexData = function (data, meshHandle) {
                if (data.BYTES_PER_ELEMENT !== this.indexSize) {
                    throw new Error("Expected index data element size to be ".concat(this.indexSize, ", not ").concat(data.BYTES_PER_ELEMENT, "."));
                }
                // TODO: maybe validate MeshHandle if given
                var gl = this.context;
    ...
    (function (WebGame) {
        var ShaderManager = /** @class */ (function () {
            ...
            ShaderManager.prototype.getFromName = function (name) {
                ...
                var Type = target;
                if (Type === undefined) {
                    console.warn("Unknown shader name '".concat(name, "'."));
    ...
    (function (WebGame) {
        var ShaderProgram = /** @class */ (function () {
            ...
            ShaderProgram.prototype.findAttribLocation = function (name, attrib) {
                ...
                if (loc === -1) {
                    console.warn("Unable to find attribute with name '".concat(name, "'."));
                    return;
                }
            ...
            ShaderProgram.prototype.compile = function () {
                ...
                if (!gl.getProgramParameter(prog, gl.LINK_STATUS)) {
                    throw "Program linking error: ".concat(gl.getProgramInfoLog(prog));
                }
    ...
    (function (WebGame) {
        ...
        var ProceduralTexture2D = /** @class */ (function (_super) {
            ...
            ProceduralTexture2D.prototype.toString = function () {
                return this.name != null ? this.name : "[ProceduralTexture2D ".concat(this.pixels.width, "x").concat(this.pixels.height, "]");
            };
            ...
            ProceduralTexture2D.prototype.setPixels = function (x, y, width, height, values) {
                ...
                if (values.length < width * height * channels) {
                    throw new Error("Expected at least ".concat(width * height * channels, " values."));
                }
        ...
        var TextureLoadable = /** @class */ (function (_super) {
            ...
            TextureLoadable.prototype.toString = function () {
                return "[TextureLoadable ".concat(this.url, "]");
            };
    ...
    (function (WebGame) {
        ...
        var UniformSampler = /** @class */ (function (_super) {
            ...
            UniformSampler.prototype.getSizeUniform = function () {
                ...
                return this.sizeUniform = this.program.addUniform("".concat(this, "_Size"), Uniform4F);
            };
